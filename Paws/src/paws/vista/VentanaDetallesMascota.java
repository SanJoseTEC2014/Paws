...
public class VentanaDetallesMascota extends JFrame {
	...
	public VentanaDetallesMascota() {
		...
		// seguir vi�ndose el texto de la especie de la Mascota claramente.
		...
		// Esto permite que cuando el ComboBox est� desactivado, pueda
		// seguir vi�ndose el texto de la raza de la Mascota claramente.
	...
	public void setDatosIniciales(Mascota mascota){
		...
		// El boton soy due�o aparece sii la mascota esta encontrada, adoptable o refugiada
		...
		// pone el boton de adoptar visible si la mascota est� encontrada o refugiada
