...
public class VentanaRegistroMascotas extends JFrame {
	...
	public VentanaRegistroMascotas() {
		...
		panelContenido.add(columnaIzq, BorderLayout.EAST);
		...
		lblRecompensa.setFont(new Font("Tahoma", Font.PLAIN, 13));
				...
				panelContenido.add(columnaDer, BorderLayout.EAST);
		...
		botonRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(getContentPane(), 
						...
						"de esta mascota en la pesta�a de Mis mascotas", "Registro Satisfactorio",
